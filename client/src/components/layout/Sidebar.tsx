...
const Sidebar: React.FC<SidebarProps> = ({ open, setOpen }) => {
  ...
  const navItems: SidebarItem[] = [
    ...
    { name: 'Лендинг', path: '/landing', icon: Globe },
    { name: t('common.preview'), path: '/preview', icon: Eye },
    { name: 'Презентация', path: '/presentation', icon: FileText },
    ...
    { name: 'VOD Check', path: '/vod-check', icon: Smartphone },
    { name: 'Модули ПЭВМ', path: '/pevm-modules', icon: FolderKanban },
    { name: 'ИИ Компоненты', path: '/ai-components', icon: Brain },
