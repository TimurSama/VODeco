...
export default function InteractivePresentation({ onComplete }: InteractivePresentationProps) {
  ...
  const hexagons: HexagonType[] = [
    ...
    },
    {
      ...
      icon: Beaker,
      color: '#8a2be2',
      position: { x: -170, y: -100 }, // Верх левый (угол 120°)
      content: {
        problems: [
    ...
    },
    {
      ...
      icon: Droplets,
      color: '#00e5ff',
      position: { x: -170, y: 100 }, // Нижний левый (угол 240°)
      content: {
        problems: [
    ...
    },
    {
      ...
      icon: DollarSign,
      color: '#ffd700',
      position: { x: 170, y: 100 }, // Нижний правый (угол 300°)
      content: {
        problems: [
    ...
    },
    {
      ...
      icon: Settings,
      color: '#0088ff',
      position: { x: 170, y: -100 }, // Верх правый (угол 60°)
      content: {
        problems: [
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden">{/* Фиксированная высота экрана */}
      ...
      {/* Центральный контейнер с глобусом - поднимаем выше */}
