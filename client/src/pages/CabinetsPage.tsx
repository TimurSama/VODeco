      ...
      <Card className="w-full border border-primary/20 bg-card/80 backdrop-blur-sm">
        <CardContent className="pt-6">
          <div className="flex flex-col items-center justify-center text-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-primary">Кабинеты</h1>
          </div>

          <p className="mt-4 text-foreground/80">
            Управление доступом к специализированным кабинетам и ролям.
          </p>
          
          <div className="mt-6 p-4 bg-secondary/10 rounded-lg border border-secondary/20">
            <p className="text-secondary text-sm">
              Получайте доступ к кабинетам и функциям в зависимости от вашей роли в экосистеме.
            </p>
          </div>
        </CardContent>
      </Card>
